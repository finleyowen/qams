...
- The header row (starting at B1) stores the names of all the options available on any criteria in the scorecard (e.g., ",YES,NO,GREAT,GOOD,BAD,N/A,FYI ONLY"). They must be unique
